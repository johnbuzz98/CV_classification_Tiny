...
class TinyImageNet200(Dataset):
    def __init__(self, train: bool = True, transform: Optional[Callable] = None, size=(224, 224)):
        super().__init__()
        self.train = train
    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        # convert to tensor and add target to the last dimension
...
def create_dataset(aug_name: str = 'default'):
